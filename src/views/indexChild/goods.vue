    ...
    <el-col>
            ...
            <el-table-column label="操作">
              <template v-slot="goods">
                <el-button
                  type="success"
                  size="mini"
                  @click="editGoods(goods.row)"
                  >编辑</el-button
                >
                <el-button
                  type="danger"
                  size="mini"
                  @click="delGoods(goods.row)"
                  >删除</el-button
                >
      ...
      <el-dialog title="添加商品" :visible.sync="addGoodsVisible" width="30%">
        ...
        >
          <el-form-item label="商品名称" prop="goods_name">
            <el-input
              v-model="addGoodsFrom.goods_name"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="价格" prop="goods_price">
            <el-input
              v-model="addGoodsFrom.goods_price"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="数量" prop="goods_number">
            <el-input
              v-model="addGoodsFrom.goods_number"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="重量" prop="goods_weight">
            <el-input
              v-model="addGoodsFrom.goods_weight"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="介绍" prop="goods_introduce">
            <el-input
              v-model="addGoodsFrom.goods_introduce"
              type="textarea"
              autocomplete="off"
            ></el-input>
          </el-form-item>
      ...
      >
        ...
        >
          <el-form-item label="商品名称" prop="goods_name">
            <el-input
              v-model="editGoodsFrom.goods_name"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="价格" prop="goods_price">
            <el-input
              v-model="editGoodsFrom.goods_price"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="数量" prop="goods_number">
            <el-input
              v-model="editGoodsFrom.goods_number"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="重量" prop="goods_weight">
            <el-input
              v-model="editGoodsFrom.goods_weight"
              type="text"
              autocomplete="off"
            ></el-input>
          </el-form-item>
    ...
    async render() {
      ...
      if (status === 200) {
        let list = res.data.data.goods.map(v => {
          v.add_time = this.$moment(+(v.add_time + "000")).format(
            "YYYY-MM-DD "
          );
          v.upd_time = this.$moment(+(v.upd_time + "000")).format(
            "YYYY-MM-DD "
          );
